...
// Çemberin çevresini hesapla: 2 * pi * yarıçap
  const cevre = 2 * pi * yaricap;
  return cevre;  // Hesaplanan çevreyi döndür
}


const result2 = CemberinCevresi(5);
console.log(result2); 
